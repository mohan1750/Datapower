...
public class DeleteFile {
	...
	public String deleteFile(String domain,String location,String name,String host,String port)
	{
	    ...
	    URL url = new URL("https://"+host+":"+port+"/service/mgmt/amp/3.0");
	            ...
	            SOAPMessage soapResponse = soapConnection.call(createSOAPRequest(domain,location,name),url);
	...
	private static SOAPMessage createSOAPRequest(String domain,String location,String name) throws Exception {
        ...
        SOAPElement soapBodyElem = soapBody.addChildElement("DeleteFileRequest","ns");
        ...
        soapBodyElem1.addAttribute(new javax.xml.namespace.QName("location"), location);
