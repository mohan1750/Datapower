...
public class FlushStylesheetCache {
	public String flushCache(String domain,String name,String host,String port)
	{
	    ...
	    SOAPMessage soapResponse = soapConnection.call(createSOAPRequest(domain,name),url);
	...
	private static SOAPMessage createSOAPRequest(String domain,String name) throws Exception {
        ...
        SOAPElement soapBodyElem2=soapBodyElem1.addChildElement("FlushStylesheetCache");
        SOAPElement soapBodyElem3=soapBodyElem2.addChildElement("XMLManager");
        soapBodyElem3.addTextNode(name);
