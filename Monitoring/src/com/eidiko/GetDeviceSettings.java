...
public class GetDeviceSettings {
	...
	public byte[] getDeviceSettings(String host,String port)
	{
	...
	private static SOAPMessage createSOAPRequest() throws Exception {
        ...
        String serverURI = "http://www.datapower.com/schemas/appliance/management/3.0/wsdl/app-mgmt-protocol/GetDeviceSettingsRequest";
        ...
        SOAPElement soapBodyElem = soapBody.addChildElement("GetDeviceSettingsRequest","ns");
