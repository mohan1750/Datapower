...
public class GetDomainExport {
	
	public byte[] getExport(String domain,String host,String port)
	{
	...
	private static SOAPMessage createSOAPRequest(String name) throws Exception {
        ...
        String serverURI = "http://www.datapower.com/schemas/appliance/management/3.0/wsdl/app-mgmt-protocol/GetDomainExportRequest";
        ...
        SOAPElement soapBodyElem = soapBody.addChildElement("GetDomainExportRequest","ns");
