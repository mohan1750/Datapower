...
public class GetErrorReport {
	...
	public byte[] getErrorReport(String host,String port)
	{
	    ...
	    URL url = new URL("https://"+host+":"+port+"/service/mgmt/amp/3.0");
	            ...
	            System.out.println();
	            String name=soapResponse.getSOAPPart().getEnvelope().getBody().getFirstChild().getFirstChild().getAttributes().getNamedItem("name").getTextContent();
	           ...
	           String location=soapResponse.getSOAPPart().getEnvelope().getBody().getFirstChild().getFirstChild().getAttributes().getNamedItem("location").getTextContent();	      
	            String URL="https://192.168.81.129:9090/webguiapp/fileAccess/startup?filename="+location.substring(0, location.length()-4)+"%3A%2F"+name;
	...
	private static SOAPMessage createSOAPRequest() throws Exception {
        ...
        String serverURI = "http://www.datapower.com/schemas/appliance/management/3.0/wsdl/app-mgmt-protocol/GetErrorReportRequest";
        ...
        SOAPElement soapBodyElem = soapBody.addChildElement("GetErrorReportRequest","ns");
