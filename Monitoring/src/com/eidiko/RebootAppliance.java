...
public class RebootAppliance {
	...
	public String  reboot(String name,String host,String port)
	{
	...
	private static SOAPMessage createSOAPRequest(String domain) throws Exception {
        ...
        SOAPElement soapBodyElem = soapBody.addChildElement("RebootRequest","ns");
        SOAPElement soapBodyElem1=soapBodyElem.addChildElement("Mode", "ns");
