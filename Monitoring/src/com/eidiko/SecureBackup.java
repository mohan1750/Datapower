...
public class SecureBackup {
	...
	public String backup(String host,String port,String location,String name)
	{
	    ...
	    URL url = new URL("https://"+host+":"+port+"/service/mgmt/amp/3.0");
	            ...
	            SOAPMessage soapResponse = soapConnection.call(createSOAPRequest(location,name),url);
	...
	private static SOAPMessage createSOAPRequest(String location,String name) throws Exception {
        ...
        SOAPElement soapBodyElem = soapBody.addChildElement("SecureBackupRequest","ns");
        SOAPElement soapBodyElem1=soapBodyElem.addChildElement("CryptoCertificateName", "ns");
        
        soapBodyElem1.addTextNode(name);
        SOAPElement sopaBodyElem2=soapBodyElem.addChildElement("SecureBackupDestination", "ns");
        sopaBodyElem2.addTextNode(location);
