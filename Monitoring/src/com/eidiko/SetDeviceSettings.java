...
public class SetDeviceSettings {
	...
	public String setDeviceSettings(String config,String host,String port)
	{
	    ...
	    URL url = new URL("https://"+host+":"+port+"/service/mgmt/amp/3.0");
	            ...
	            SOAPMessage soapResponse = soapConnection.call(createSOAPRequest(config),url);
	...
	private static SOAPMessage createSOAPRequest(String config) throws Exception {
        ...
        SOAPElement soapBodyElem = soapBody.addChildElement("SetDeviceSettingsRequest","ns");
        SOAPElement soapBodyElem1=soapBodyElem.addChildElement("Settings", "ns");
