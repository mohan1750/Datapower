...
public class SetDomainConfig {
	
	public String setDomainConfig(String name,String config,String host,String port)
	{
	    ...
	    URL url = new URL("https://"+host+":"+port+"/service/mgmt/amp/3.0");
	            ...
	            SOAPMessage soapResponse = soapConnection.call(createSOAPRequest(name,config),url);
	...
	private static SOAPMessage createSOAPRequest(String domain,String config) throws Exception {
        ...
        SOAPElement soapBodyElem = soapBody.addChildElement("SetDomainConfigRequest","ns");
        SOAPElement soapBodyElem1=soapBodyElem.addChildElement("Config", "ns");
