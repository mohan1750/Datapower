...
public class SetFirmware {
	
	public String setFirmware(String accept,String config,String host,String port)
	{
	    ...
	    URL url = new URL("https://"+host+":"+port+"/service/mgmt/amp/3.0");
	            ...
	            SOAPMessage soapResponse = soapConnection.call(createSOAPRequest(accept,config),url);
	...
	private static SOAPMessage createSOAPRequest(String accept,String config) throws Exception {
        ...
        SOAPElement soapBodyElem = soapBody.addChildElement("SetFirmwareRequest","ns");
        SOAPElement soapBodyElem1=soapBodyElem.addChildElement("AcceptLicense", "ns"); 
        soapBodyElem1.addTextNode(accept);
        SOAPElement soapBodyElem2=soapBodyElem.addChildElement("Firmware", "ns"); 
