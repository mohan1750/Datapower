...
public class Unquiesce {
	
	public String unquiesce(String domain,String type,String host,String port)
	{
	    ...
	    URL url = new URL("https://"+host+":"+port+"/service/mgmt/amp/3.0");
	            ...
	            SOAPMessage soapResponse = soapConnection.call(createSOAPRequest(domain,type),url);
	...
	private static SOAPMessage createSOAPRequest(String domain,String type) throws Exception {
        ...
        SOAPElement soapBodyElem = soapBody.addChildElement("UnquiesceRequest","ns");
