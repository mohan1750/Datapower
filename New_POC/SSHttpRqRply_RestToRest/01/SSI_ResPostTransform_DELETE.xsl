...
<xsl:value-of select="$routingURL"/>
		...
		<xsl:variable name="input" select="dp:local-variable('var://local/PostTransformOut')"/>
		
		<dp:set-variable name="'var://context/Delete/routing-url'" value="$routingURL"/>
		<dp:set-variable name="'var://context/Delete/backend-timeout'" value="$timeout"/>
		<dp:set-variable name="'var://context/Delete/sslProxyProfile'" value="$sslProxyProfile"/>
		<dp:set-variable name="'var://context/Delete/Input'" value="$input"/>
	</xsl:template>
